  ...
  const onSubmit = async (data: SignInFormData) => {
    try {
      const response = await fetch("/api/admin/login", {
        ...
        body: JSON.stringify({ ...data, portal: "master" }),
      });
          ...
          <div className="flex h-full w-full items-center justify-center px-[32px] py-[20px]">
            ...
            >
              ...
              <div className="flex flex-col gap-[10px]">
                ...
                <p className="mt-2 text-center font-source-sans text-[12px] leading-[18px] text-(--color-auth-subtle-60)">
                  Distributor accounts are provisioned by the system owner. Contact
