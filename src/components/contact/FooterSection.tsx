...
export function FooterSection() {
  return (
    <footer className="bg-slate-50 pb-6">
      <div className="mx-auto w-full pt-14 sm:px-6">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[1.3fr_3fr] px-[104px]">
          <div>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-3 border-t border-slate-200 pt-4 text-sm text-slate-500 sm:flex-row sm:items-center">
