        ...
        <table className="w-full min-w-[720px] border-collapse text-left">
          <thead>
            <tr className="border-b border-[#dfd5c3]">
              <th className="sticky left-0 z-10 bg-[#fcfbf8] px-4 py-2.5 font-[family-name:var(--font-dm-sans)] text-[9px] font-bold uppercase leading-[13.5px] tracking-[0.3px] text-[#7c736a]">
                Feature
              </th>
              {COMPARISON_DESIGNS.map((d) => (
                <th
                  key={d.id}
                  className={`px-3 py-2.5 text-center font-[family-name:var(--font-dm-sans)] text-[9px] font-bold uppercase leading-[13.5px] tracking-[0.3px] ${
          ...
          <tbody>
            {COMPARISON_ROWS.map((row, i) => {
              ...
              return (
                ...
                >
                  <td
                    className={`sticky left-0 z-10 px-4 py-2.5 font-[family-name:var(--font-dm-sans)] text-[11px] font-normal capitalize leading-[16.5px] text-[#7c736a] ${rowBg}`}
                  >
                    {row.feature}
                  </td>
                  {row.values.map((cell, j) => (
                    <td
                      key={`${row.feature}-${j}`}
                      className={`px-3 py-2.5 text-center font-[family-name:var(--font-dm-sans)] text-[11px] leading-[16.5px] text-[#7c736a] ${
                        j === colIdx
