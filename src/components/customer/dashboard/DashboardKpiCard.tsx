...
export function DashboardKpiCard({
  ...
  return (
    <div className="flex min-h-[115px] flex-col rounded-[10px] border border-[#dfd5c3] bg-[#fcfbf8] p-4">
      ...
      <p className="mt-3 font-[family-name:var(--font-inter)] text-2xl font-bold leading-7 text-[#2a2622]">
        {value}
      </p>
      <p
        className="mt-1 font-[family-name:var(--font-dm-sans)] text-[10px] font-normal leading-[15px] text-[rgba(124,115,106,0.5)]"
        style={{ fontVariationSettings: "'opsz' 9" }}
      >
        {sublabel}
      </p>
