...
import { createInstallerNote, type InstallerNote } from "@/lib/installers/notes";

type Props = {
  open: boolean;
  onClose: () => void;
  customerId?: string | null;
  onCreated?: (note: InstallerNote) => void;
};

export function InstallerCreateNoteModal({
  open,
  onClose,
  customerId,
  onCreated,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const saved = await createInstallerNote({
