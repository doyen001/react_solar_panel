...
function CheckIcon() {
  return (
    <div className="flex size-6 items-center justify-center rounded-full bg-[rgba(22,162,73,0.2)]">
...
function XIcon() {
  return (
    <div className="flex size-6 items-center justify-center rounded-full bg-[#f1f5f9]">
...
function WarningIcon() {
  return (
    <div className="flex size-6 items-center justify-center rounded-full bg-[rgba(239,67,67,0.2)]">
    ...
    <section className="bg-white px-4 py-16 sm:px-6 lg:py-[87px]">
      <div className="mx-auto max-w-[768px]">
        ...
        <div className="text-center">
          ...
          <h3 className="mt-4 font-source-sans text-xl font-semibold tracking-[-0.5px] text-[#111c27]">
            Why Easylink is better than the rest?
          </h3>
          <p className="mx-auto mt-4 max-w-[657px] font-source-sans text-base leading-6 text-[#65758b]">
        ...
        <div className="mt-10 overflow-x-auto rounded-2xl bg-white shadow-[0_8px_32px_-8px_rgba(17,28,39,0.12)]">
          ...
          {/* Header row */}
          <div className="flex items-center border-b border-[#e1e7ef] bg-[rgba(241,245,249,0.5)] px-4 py-4">
            <span className="flex-1 font-source-sans text-sm font-semibold text-[#111c27]">Features</span>
            <span className="w-[150px] text-center font-source-sans text-sm font-semibold text-[#05afd1] sm:w-[200px]">Easylink Solar</span>
            <span className="w-[120px] text-center font-source-sans text-sm font-semibold text-[#65758b] sm:w-[160px]">Competitors</span>
          </div>
          ...
          {features.map((f, i) => {
            ...
            return (
              <div
                key={f.name}
                className={`flex items-center px-4 py-4 ${!isLast ? "border-b border-[#e1e7ef]" : ""}`}
              >
                <span className="flex-1 font-source-sans text-sm text-[#111c27]">{f.name}</span>
