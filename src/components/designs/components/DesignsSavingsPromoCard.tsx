...
export function DesignsSavingsPromoCard({
  ...
  return (
    <div
      className={`relative flex min-h-[411px] w-full max-w-[629px] shrink-0 flex-col overflow-hidden rounded-[30px] border-[3px] border-design-accent-cyan bg-linear-to-r from-yellow-lemon to-orange-amber shadow-[0px_0px_40px_0px_rgba(140,140,140,0.3)] ${className ?? ""}`}
    >
