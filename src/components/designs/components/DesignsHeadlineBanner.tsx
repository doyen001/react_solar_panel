...
export function DesignsHeadlineBanner() {
  return (
    <div
      className="mx-auto flex w-full max-w-[1278px] min-h-[173px] items-center justify-center overflow-hidden rounded-[46px] border-[3px] border-design-accent-cyan bg-linear-to-r from-yellow-lemon to-orange-amber px-5 shadow-[0px_0px_40px_0px_rgba(140,140,140,0.3)]"
    >
      <p
